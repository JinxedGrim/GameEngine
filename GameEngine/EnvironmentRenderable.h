...
public:
	...
	virtual Color Render(const int x, const int y, const float invWidth, const float invHeight, const float& Fov, const float& AspectRatio, const Matrix3x3& CamRot) = 0;
};